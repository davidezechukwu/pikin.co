...
export class PrizeModelMockDataBuilder extends SuperModelMockDataBuilder {
    ...
    BuildPick10Mock(): PrizeModel[] {
        var me = this;
        let pick10 = GamesMock.find(function (game : any) { return game.Name.toLowerCase() == WinningPriceModel.Pick10GameName.toLowerCase() });
        if (!pick10) {
            throw "The Game " + WinningPriceModel.Pick10GameName + " could not be found";
        }
        ...
        pick10Match8.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick10Match8WinPrice, this.DefaultCurrency!);
        ...
        pick10Match9.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick10Match9WinPrice, this.DefaultCurrency!);
        ...
        pick10Match10.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick10Match10WinPrice, this.DefaultCurrency!);
    ...
    BuildPick9Mock(): PrizeModel[] {
        var me = this;
        let pick9 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick9GameName.toLowerCase() });
        if (!pick9) {
            throw "The Game " + WinningPriceModel.Pick9GameName + " could not be found";
        }
        ...
        pick9Match7.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick9Match7WinPrice, this.DefaultCurrency!);
        ...
        pick9Match8.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick9Match8WinPrice, this.DefaultCurrency!);
        ...
        pick9Match9.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick9Match9WinPrice, this.DefaultCurrency!);
    ...
    BuildPick8Mock(): PrizeModel[] {
        var me = this;
        let pick8 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick8GameName.toLowerCase() });
        if (!pick8) {
            throw "The Game " + WinningPriceModel.Pick8GameName + " could not be found";
        }
        ...
        pick8Match6.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick8Match6WinPrice, this.DefaultCurrency!);
        ...
        pick8Match7.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick8Match7WinPrice, this.DefaultCurrency!);
        ...
        pick8Match8.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick8Match8WinPrice, this.DefaultCurrency!);
    ...
    BuildPick7Mock(): PrizeModel[] {
        var me = this;
        let pick7 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick7GameName.toLowerCase() });
        if (!pick7) {
            throw "The Game " + WinningPriceModel.Pick7GameName + " could not be found";
        }
        ...
        pick7Match5.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick7Match5WinPrice, this.DefaultCurrency!);
        ...
        pick7Match6.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick7Match6WinPrice, this.DefaultCurrency!);
        ...
        pick7Match7.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick7Match7WinPrice, this.DefaultCurrency!);
    ...
    BuildPick6Mock(): PrizeModel[] {
        var me = this;
        let pick6 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick6GameName.toLowerCase() });
        if (!pick6) {
            throw "The Game " + WinningPriceModel.Pick6GameName + " could not be found";
        }
        ...
        pick6Match4.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick6Match4WinPrice, this.DefaultCurrency!);
        ...
        pick6Match5.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick6Match5WinPrice, this.DefaultCurrency!);
        ...
        pick6Match6.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick6Match6WinPrice, this.DefaultCurrency!);
    ...
    BuildPick5Mock(): PrizeModel[] {
        var me = this;
        let pick5 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick5GameName.toLowerCase() });
        if (!pick5) {
            throw "The Game " + WinningPriceModel.Pick5GameName + " could not be found";
        }
        ...
        pick5Match3.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick5Match3WinPrice, this.DefaultCurrency!);
        ...
        pick5Match4.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick5Match4WinPrice, this.DefaultCurrency!);
        ...
        pick5Match5.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick5Match5WinPrice, this.DefaultCurrency!);
    ...
    BuildPick4Mock(): PrizeModel[] {
        var me = this;
        let pick4 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick4GameName.toLowerCase() });
        if (!pick4) {
            throw "The Game " + WinningPriceModel.Pick4GameName + " could not be found";
        }
        ...
        pick4Match2.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick4Match2WinPrice, this.DefaultCurrency!);
        ...
        pick4Match3.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick4Match3WinPrice, this.DefaultCurrency!);
        ...
        pick4Match4.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick4Match4WinPrice, this.DefaultCurrency!);
    ...
    BuildPick3Mock(): PrizeModel[] {
        var me = this;
        let pick3 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick3GameName.toLowerCase() });
        if (!pick3) {
            throw "The Game " + WinningPriceModel.Pick3GameName + " could not be found";
        }
        ...
        pick3Match1.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick3Match1WinPrice, this.DefaultCurrency!);
        ...
        pick3Match2.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick3Match2WinPrice, this.DefaultCurrency!);
        ...
        pick3Match3.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick3Match3WinPrice, this.DefaultCurrency!);
    ...
    BuildPick2Mock(): PrizeModel[] {
        var me = this;
        let pick2 = GamesMock.find(function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick2GameName.toLowerCase() });
        if (!pick2) {
            throw "The Game " + WinningPriceModel.Pick2GameName + " could not be found";
        }
        ...
        pick2Match1.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick2Match1WinPrice, this.DefaultCurrency!);
        ...
        pick2Match2.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick2Match2WinPrice, this.DefaultCurrency!);
    ...
    BuildPick1Mock(): PrizeModel[] {
        var me = this;
        let pick1 = GamesMock.find( function (game: any) { return game.Name.toLowerCase() == WinningPriceModel.Pick1GameName.toLowerCase() });
        if (!pick1) {
            throw "The Game " + WinningPriceModel.Pick1GameName + " could not be found";
        }
        ...
        pick1Match1.WinPrice = new CurrencyAmountModel(WinningPriceModel.Pick1Match1WinPrice, this.DefaultCurrency!);
