...
export class PrizeModelMockDataBuilder extends SuperModelMockDataBuilder {
    ...
    protected Pick9Match9WinPrice = 6000000;
    protected Pick9Match8WinPrice = 600000;
    protected Pick9Match7WinPrice = 60000;
    protected Pick8Match8WinPrice = 900000;
    protected Pick8Match7WinPrice = 90000;
    protected Pick8Match6WinPrice = 9000;
    protected Pick7Match7WinPrice = 120000;
    protected Pick7Match6WinPrice = 12000;
    protected Pick7Match5WinPrice = 1200;
    protected Pick6Match6WinPrice = 15000;
    protected Pick6Match5WinPrice = 1500;
    protected Pick6Match4WinPrice = 150;
    protected Pick5Match5WinPrice = 1800;
    protected Pick5Match4WinPrice = 180;
    protected Pick5Match3WinPrice = 18;
    protected Pick4Match4WinPrice = 210;
    protected Pick4Match3WinPrice = 21;
    protected Pick4Match2WinPrice = 2.10;
    protected Pick3Match3WinPrice = 24;
    protected Pick3Match2WinPrice = 2.4;
    protected Pick3Match1WinPrice = 0.24;
    protected Pick2Match2WinPrice = 2.70;
    protected Pick2Match1WinPrice = 0.27;
    protected Pick1Match1WinPrice = 0.30;

    protected Pick10GameName = "Pick10";
    protected Pick9GameName = "Pick9";
    protected Pick8GameName = "Pick8";
    protected Pick7GameName = "Pick7";
    protected Pick6GameName = "Pick6";
    protected Pick5GameName = "Pick5";
    protected Pick4GameName = "Pick4";
    protected Pick3GameName = "Pick3";
    protected Pick2GameName = "Pick2";
    protected Pick1GameName = "Pick1";
