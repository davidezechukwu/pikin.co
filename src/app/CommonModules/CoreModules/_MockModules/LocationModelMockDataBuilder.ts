...
export class LocationModelMockDataBuilder extends SuperModelMockDataBuilder {    
    ...
    BuildNigerianLocationsMock(): LocationModel[] {
        ...
        return nigerianLocationsMock;
    }

    BuildOtherCountriesMock(): LocationModel[] {
        var me = this;
        var rawCountryList = [
...
export var LocationsMock = new LocationModelMockDataBuilder().BuildMock();
