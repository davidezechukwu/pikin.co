...
@Component({
    selector: 'ContactUsByPostPage',
    templateUrl: './ContactUsByPostPage.ng.html',
    styleUrls: ["./ContactUsByPostPage.scss"],
    animations: PageAnimations,
    imports: [RootCollapserComponent, RootBackgroundComponent, RouterModule]
})
export class ContactUsByPostPage extends SuperPage {
